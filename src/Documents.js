...
const Documents=({downloadCv,downloadCoverLetter,downloadResume})=>{
...
<button className="f6 link dim br2 ba ph3 pv2 mb2 dib navy" href="#0" onClick={downloadCoverLetter} type="submit" >Download Coverletter</button>
</div>
<div className="  w-25 pa3 mr2 grow ma1">
